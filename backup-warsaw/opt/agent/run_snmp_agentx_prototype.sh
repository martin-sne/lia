...
TMPDIR="$(mktemp --directory --tmpdir snmp_agentx_prototype.XXXXXXXXXX)"
...
agentaddress 145.100.106.130:5555
...
echo ""
echo "    cd `pwd`"
echo "    snmpwalk -v 2c -c public -M+. 145.100.106.130:5555 ARPA2-Experimental-DNSSEC-MIBv1::arpa2experimentaldnssecMIBv1"
echo "    snmpget -v 2c -c public -M+. 145.100.106.130:5555 ARPA2-Experimental-DNSSEC-MIBv1::dnssecZoneCount.0"
echo "    snmptable -v 2c -c public -M+. -Ci 145.100.106.130:5555 ARPA2-Experimental-DNSSEC-MIBv1::dnssecGlobalTable"
echo ""
...
python snmp_agentx_prototype.py -m $TMPDIR/snmpd-agentx.sock -p $TMPDIR/
