...
TMPDIR="$(mktemp --directory --tmpdir prototype_agent.XXXXXXXXXX)"
...
echo ""
echo "    cd `pwd`"
echo "    snmpwalk -v 2c -c public -M+. localhost:5555 DNSSEC-MIBv2::dnssecMIBv2"
echo "    snmpget -v 2c -c public -M+. localhost:5555 DNSSEC-MIBv2::dnssecZoneCount.0"
echo "    snmptable -v 2c -c public -M+. -Ci localhost:5555 DNSSEC-MIBv2::dnssecGlobalTable"
echo ""
...
python prototype_agent2.py -m $TMPDIR/snmpd-agentx.sock -p $TMPDIR/
