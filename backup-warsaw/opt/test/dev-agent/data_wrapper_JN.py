...
# Check if zones are reachable
#for zones in zone:
#	ping = os.system("ping -c 1 " + zones + " > /dev/null 2>&1")
#	if ping != 0:
#		zone.remove(zones)
#		values[str(zones + "_dnssecZoneSigTable_2")] = str('"'"Zone not Reachable"'"')
#        	values[str(zones + "_dnssecZoneSigTable_3")] = str('"'"Zone not Reachable"'"')
#        	values[str(zones + "_dnssecZoneSigTable_4")] = str('"'"Zone not Reachable"'"')
#        	values[str(zones + "_dnssecZoneSigTable_5")] = str('"'"Zone not Reachable"'"')
#	      	values[str(zones + "_dnssecZoneDiffTable_2")] = str('"'"Zone not Reachable"'"')
